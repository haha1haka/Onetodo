...
//    var todos: [TestToDo]
//    
//    init(title: String, todos: [TestToDo]) {
//        self.title = title
//        self.todos = todos
//    }
//    
...
//}
//extension Section {
//  static var allSections: [Section] = [Section(title: "화", todos: [TestToDo(todoLabel: "밥먹기"),
//                                                                   TestToDo(todoLabel: "자전거타기"),
//                                                                   TestToDo(todoLabel: "엄마한테 전화하기")
//                                                                  ]
//                                              )
//                                      ]
//}
...
//    
//    var collectionViewDataSource: UICollectionViewDiffableDataSource<Section, TestToDo>!
//    
...
//    
//    
//    typealias DataSource = UICollectionViewDiffableDataSource<Section, TestToDo>
//    
//    
...
//        let topicCellRegistration = UICollectionView.CellRegistration<PanelCell, TestToDo> { cell,indexPath,itemIdentifier in
